...
module Gage
  module Stage
    ...
    GAGE_DIR = '/usr/local/www/vamps/projects/seabase/gage/' #'/Users/matt/src/github/species_file_group/gage/'

    # Data originate here
    SOURCE_DATA_DIR = '/usr/local/www/vamps/projects/seabase/data/' #'/Users/matt/src/github/species_file_group/gage/raw_data'
